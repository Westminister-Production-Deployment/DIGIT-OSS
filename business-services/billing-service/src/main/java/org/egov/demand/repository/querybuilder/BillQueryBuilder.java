...
public class BillQueryBuilder {
	...
	public static final String INSERT_BILL_QUERY = "INSERT into egbs_bill_v1 "
			+"(id, tenantid, payername, payeraddress, payeremail, isactive, iscancelled, createdby, createddate, lastmodifiedby, lastmodifieddate, mobilenumber, status, additionaldetails, consumercode)"
			+"values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
